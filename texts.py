...
SUPPORT_TEXT = (
    ...
    "✉️ لطفاً مشکل خود را *کامل، واضح و دقیق* توضیح دهید.\n\n"
    "✅ پس از ارسال پیام، برای ثبت درخواست خود روی دکمه *«ارسال تیکت»* کلیک کنید تا مشکل شما برای تیم پشتیبانی ارسال و بررسی شود."
)
