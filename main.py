...
async def callback_router(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data in ("auth", "card_list", "add_card", "remove_card") or data.startswith("del_card_") or data.startswith("confirm_del_card_"):
        await user_panel.handle_auth_buttons(update, context)
        return

    if data in ("buy_package", "buy_question", "back_to_main", "back_to_balance", "back_to_packages"):
